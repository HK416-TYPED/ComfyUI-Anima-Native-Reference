...
import torch
from _anima_native_ref_vendor.library.sdxl_original_unet import InferSdxlUNet2DConditionModel
...
def detect_arch_config(unet, text_encoders) -> ArchConfig:
    ...
    from _anima_native_ref_vendor.library.sdxl_original_unet import SdxlUNet2DConditionModel
...
class AdditionalNetwork(torch.nn.Module):
    ...
    def save_weights(self, file, dtype, metadata):
        ...
        if os.path.splitext(file)[1] == ".safetensors":
            ...
            from _anima_native_ref_vendor.library import train_util
