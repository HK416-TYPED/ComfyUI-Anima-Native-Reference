...
# from _anima_native_ref_vendor.library.train_util import ImageInfo
...
class LatentsCachingStrategy:
    ...
    def _default_cache_batch_latents(
        ...
        Returns:
            None
        """
        from _anima_native_ref_vendor.library import train_util  # import here to avoid circular import
