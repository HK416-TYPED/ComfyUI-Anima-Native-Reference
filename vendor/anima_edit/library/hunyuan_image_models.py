...
from _anima_native_ref_vendor.library.attention import AttentionParams
...
from _anima_native_ref_vendor.library.hunyuan_image_modules import (
    SingleTokenRefiner,
    ByT5Mapper,
    PatchEmbed2D,
    TimestepEmbedder,
...
from _anima_native_ref_vendor.library.hunyuan_image_utils import get_nd_rotary_pos_embed
